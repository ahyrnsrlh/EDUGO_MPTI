...
class FrontendDashboardController extends Controller
{
    ...
    {
        $all_courses = Course::with(['category', 'user', 'course_goal'])
                            ->where('status', 1)
        ...
        return view('frontend.pages.all-courses.index', compact('all_courses', 'categories'));
    }
    ...
    public function coursesByCategory($slug)
    {
        ...
        return view('frontend.pages.all-courses.index', compact('all_courses', 'categories', 'currentCategory'));
    }
}
