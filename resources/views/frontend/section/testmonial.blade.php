<section class="testimonial-area section-padding">
    <div class="container">
        <div class="section-heading text-center">
            ...
            <h2 class="section__title">Feedback Siswa & Guru</h2>
        ...
        <div class="testimonial-carousel owl-action-styled">
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        My children and I LOVE Edugo! The courses are fantastic and the
            ...
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Thank you Edugo! You've renewed my passion for
