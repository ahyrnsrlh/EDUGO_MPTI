<section class="course-area pb-120px" style="background-color: white; padding-top: 80px;">
    <div class="container">
        <div class="section-heading text-center">
            <h5 class="ribbon ribbon-lg mb-2">Jelajahi Kursus SMK 1 Mendo Barat</h5>
            <h2 class="section__title">Program Keahlian & Mata Pelajaran Terpilih</h2>
    ...
    <div class="card-content-wrapper pt-50px pb-120px" style="background-color: white;">
        <div class="container">
                                        ...
                                        <div class="card-image">
                                            ...
                                            <div class="course-badge-labels">
                                                ...
                                                <div class="course-badge blue">
                                                    ...
                                                    -{{ $course->selling_price > 0 ? round((($course->selling_price - $course->discount_price) / $course->selling_price) * 100) : 0 }}%
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <p class="card-price text-black font-weight-bold">
                                                    Rp {{ number_format($course->discount_price * 15000, 0, ',', '.') }} <span
                                                        class="before-price font-weight-medium">Rp {{ number_format($course->selling_price * 15000, 0, ',', '.') }}</span>
                                                </p>
            ...
            <div class="more-btn-box mt-4 text-center">
                <a href="{{ route('all.courses') }}" class="btn theme-btn">Lihat Semua Kursus <i
