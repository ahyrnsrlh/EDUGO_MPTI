<div class="course-overview-card">
    <h3 class="fs-24 font-weight-semi-bold pb-3">Deskripsi</h3>
...
<div class="course-overview-card">
    <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
        <h3 class="fs-24 font-weight-semi-bold">Konten Kursus</h3>
        <div class="curriculum-duration fs-15">
            <span class="curriculum-total__text mr-2"><strong
                class="text-black font-weight-semi-bold">Total:</strong> {{$total_lecture}} materi</span>


            <span class="curriculum-total__hours"><strong
                    class="text-black font-weight-semi-bold">Total jam:</strong>
                02:35:47</span>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header" id="heading-{{ $index }}">
                    <button
                        ...
                        {{ $item->section_title }}
                        <span class="fs-15 text-gray font-weight-medium">{{$item['lecture']->count()}} materi</span>
                    </button>
                </div><!-- end card-header -->
