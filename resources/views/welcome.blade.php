...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>YouTubeLMS - Platform Pembelajaran Online</title>
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="text-center mb-12">
                            <h1 class="text-4xl font-bold text-black dark:text-white mb-4">
                                Selamat Datang di YouTubeLMS
                            </h1>
                            <p class="text-xl text-gray-600 dark:text-gray-300">
                                Platform pembelajaran online terbaik untuk mengembangkan kemampuan Anda
                            </p>
                        </div>
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                    ...
                                    <div class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                Kelola semua aspek platform pembelajaran. Atur kursus, instruktur, siswa, dan pengaturan sistem dengan mudah.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Panel Instruktur</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Area khusus untuk instruktur. Buat dan kelola kursus Anda, pantau progress siswa, dan berinteraksi dengan komunitas belajar.
                                    </p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Mulai Belajar</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Bergabunglah dengan ribuan siswa yang telah meningkatkan kemampuan mereka. Akses kursus berkualitas tinggi dari instruktur berpengalaman.
                                    </p>
                                </div>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Fitur Unggulan</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Platform kami dilengkapi dengan video berkualitas HD, quiz interaktif, sertifikat completion, dan forum diskusi untuk pengalaman belajar yang optimal.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-16 text-center">
                            <div class="grid gap-6 lg:grid-cols-3 lg:gap-8">
                                <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-300 dark:bg-zinc-900 dark:ring-zinc-800">
                                    <h3 class="text-lg font-semibold text-black dark:text-white mb-2">📚 Kursus Berkualitas</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Lebih dari 100+ kursus dari berbagai bidang teknologi dan bisnis</p>
                                </div>
                                <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-300 dark:bg-zinc-900 dark:ring-zinc-800">
                                    <h3 class="text-lg font-semibold text-black dark:text-white mb-2">👨‍🏫 Instruktur Ahli</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Belajar dari praktisi industri dengan pengalaman bertahun-tahun</p>
                                </div>
                                <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-300 dark:bg-zinc-900 dark:ring-zinc-800">
                                    <h3 class="text-lg font-semibold text-black dark:text-white mb-2">🏆 Sertifikat Resmi</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Dapatkan sertifikat yang diakui industri setelah menyelesaikan kursus</p>
                                </div>
                            </div>
                        </div>
                    </main>
                    ...
                    <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                        <p>&copy; 2025 YouTubeLMS. Platform Pembelajaran Online Terbaik Indonesia.</p>
                        <p class="mt-2">Dibangun dengan ❤️ menggunakan Laravel v{{ Illuminate\Foundation\Application::VERSION }}</p>
                    </footer>
                </div>
            </div>
        </div>
