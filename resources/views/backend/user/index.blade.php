    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="pl-4">
                    <p class="card-text fs-18">Kursus Terdaftar</p>
    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="pl-4">
                    <p class="card-text fs-18">Kursus Favorit</p>
                    <h5 class="card-title pt-2 fs-26">{{ $wishlistCoursesCount ?? 0 }}</h5>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div><!-- end col-lg-4 -->
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="pl-4">
                    <p class="card-text fs-18">Total Pembelian</p>
                    <h5 class="card-title pt-2 fs-26">Rp {{ number_format($totalPurchaseAmount ?? 0, 0, ',', '.') }}</h5>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div><!-- end col-lg-4 -->
