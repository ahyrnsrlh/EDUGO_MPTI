        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Edit Tujuan</li>
                </ol>
            </div>
            <h4 class="page-title">Edit Tujuan Pembelajaran</h4>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title mb-0">Edit Tujuan Pembelajaran</h4>
            ...
            <div class="card-body">
                <form action="{{ route('admin.course.goals.update', [$course->id, $goal->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('goal_name') is-invalid @enderror" 
                                          ...
                                          required>{{ old('goal_name', $goal->goal_name) }}</textarea>
                                @error('goal_name')
                            ...
                            <div class="card border-light bg-light mt-3">
                                <div class="card-body">
                                    ...
                                    <p class="small text-muted mb-1">
                                        <strong>Dibuat:</strong> {{ $goal->created_at->format('d M Y, H:i') }}
                                    </p>
                                    @if($goal->updated_at != $goal->created_at)
                                    <p class="small text-muted mb-0">
                                        <strong>Diperbarui:</strong> {{ $goal->updated_at->format('d M Y, H:i') }}
                                    </p>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-content-save"></i> Perbarui Tujuan
                                </button>
                            </div>
                        </div>
                    </div>
