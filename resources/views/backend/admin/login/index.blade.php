                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    ...
                                    <div class="text-center mb-4">
                                        <h5 class="">Admin EduGo</h5>
                                        <p class="mb-0">Silakan masuk ke akun admin Anda</p>
                                    </div>
                                    <div class="form-body">
                                        ...
                                        <form class="row g-3" method="post" action="{{ route('login') }}">
											...
											<div class="col-12">
												...
												<input type="email" class="form-control" name="email" id="inputEmailAddress" value="{{ old('email') }}" placeholder="admin@edugo.com">
                                                <x-input-error :messages="$errors->get('email')" class="mt-2" />
											</div>
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Kata Sandi</label>
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" name="password" id="inputChoosePassword"  placeholder="Masukkan Kata Sandi">
